...
const STATION_TIERS = [
  ...
  {
    tier: "RTX 5090 VIP Experience",
    specs: {
      cpu: "Intel Core Ultra 9 285K",
      gpu: "NVIDIA RTX 5090 32GB",
      ram: "64GB DDR5 Dominator",
      monitor: "4K 240Hz 32\" QD-OLED",
      keyboard: "Custom Hall-Effect Keyboard",
    },
    price: "₹250 / hr",
    isFeatured: true,
  },
            ...
            <motion.div
              ...
              className={`relative rounded border transition-all duration-500 flex flex-col justify-between overflow-hidden group ${
                tier.isFeatured
                  ...
                  : "bg-white/5 border-white/10 p-6 hover:border-white/20"
              }`}
            >
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center gap-3">
                    <Cpu size={18} className="text-gtr-neon-red shrink-0" />
                    <div>
                      <span className="text-[10px] text-gtr-off-white block uppercase tracking-wider">Graphics</span>
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[10px] text-gtr-off-white block uppercase tracking-wider">Memory (RAM)</span>
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[10px] text-gtr-off-white block uppercase tracking-wider">Display</span>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                ...
                <Link
                  href="/contact?enquiry=booking"
                  className={`flex items-center gap-1.5 font-orbitron font-bold text-xs tracking-wider uppercase transition-colors duration-300 ${
                    tier.isFeatured
                      ? "text-white hover:text-gtr-neon-red"
                      : "text-gtr-neon-red hover:text-white"
                  }`}
                >
